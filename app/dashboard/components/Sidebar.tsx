...
export const Sidebar = ({ onLinkClick }: { onLinkClick?: () => void }) => {
  ...
  const [links, setLinks] = useState<SidebarLink[]>([
    ...
    },
    {
      ...
      icon: <InfoIcon className="text-blue-500 text-lg" />,
